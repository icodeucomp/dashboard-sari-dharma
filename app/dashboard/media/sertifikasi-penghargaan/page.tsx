...
import { 
  getSertifikasiPenghargaan, 
  deleteSertifikasiPenghargaan, 
  SertifikasiPenghargaanItem 
...
export default function IndikatorMutu() {
  ...
  const [indikatorMutu, setIndikatorMutu] = useState<SertifikasiPenghargaanItem[]>([]);
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await getSertifikasiPenghargaan(params);
  ...
  const handleDelete = async (id: string) => {
    if (window.confirm("Apakah Anda yakin ingin menghapus indikator mutu ini?")) {
      try {
        setIsDeleting(true);
        const response = await deleteSertifikasiPenghargaan(id);
                  ...
                  <div className="relative" ref={(el) => { dropdownRefs.current[indikator.id] = el; }}>
                    ...
                    {openDropdownId === indikator.id && (
                      ...
                      >
                        ...
                        <Link
                          href={`/dashboard/media/sertifikasi-penghargaan/edit/${indikator.slug}/${indikator.id}`}
