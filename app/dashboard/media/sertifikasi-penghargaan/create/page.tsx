...
/**
 * Halaman untuk menambahkan Sertifikasi & Penghargaan baru
 * @returns {JSX.Element}
 */
export default function AddSertifikasiPenghargaan() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Redirect ke halaman Sertifikasi & Penghargaan setelah berhasil
    ...
    <div className="p-6">
      ...
      <div className="flex justify-between items-center mb-6 border-b border-gray-300 pb-[16px]">
        <h1 className="text-2xl font-bold text-gray-800 dark:text-white">
          Add New Sertifikasi & Penghargaan
        </h1>
      </div>
