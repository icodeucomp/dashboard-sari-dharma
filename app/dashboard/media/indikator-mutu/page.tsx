...
import imgCard from "@/app/assets/images/media/indikator-mutu/column.png";
...
export default function IndikatorMutu() {
  // Data indikator mutu
  const indikatorMutu = Array(12).fill({
    id: 1,
    title: "Indikator Mutu 2019",
  });
  ...
  const currentItems = indikatorMutu.slice(indexOfFirstItem, indexOfLastItem);
  ...
  return (
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-5 gap-6">
        {currentItems.map((indikator, index) => (
          <div
            key={index}
            className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden"
          >
            {/* Gambar indikator mutu */}
            <Image
              src={imgCard}
              alt={indikator.title}
              width={300}
            ...
            <div className="p-4">
              ...
              <div className="flex justify-between">
                {/* Tombol Edit */}
                <Link
                  href={`/dashboard/media/indikator-mutu/edit/${indikator.id}`}
                ...
                {/* Tombol Hapus */}
                <button
                  onClick={() => console.log(`Hapus indikator ${indikator.id}`)}
      ...
      <Pagination
        ...
        totalItems={indikatorMutu.length}
