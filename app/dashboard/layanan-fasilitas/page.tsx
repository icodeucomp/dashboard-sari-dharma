...
export default function LayananUnggulan() {
  ...
  const layananUnggulan = [
    { id: 1, title: "Laboratarium", image: img1 },
    { id: 2, title: "Laboratarium", image: img1 },
    { id: 3, title: "Laboratarium", image: img1 },
  ...
  const currentItems = layananUnggulan.slice(indexOfFirstItem, indexOfLastItem);
  ...
  return (
    <div className="p-6">
      ...
      <Pagination
        ...
        totalItems={layananUnggulan.length}
